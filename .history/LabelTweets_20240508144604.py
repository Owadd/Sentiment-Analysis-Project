...
# Save the DataFrame with sentiment analysis data to a new CSV file
df.to_csv("sentiment_analyzed_tweets.csv", index=False)  # Adjust filename as needed
print("Sentiment analysis results saved to sentiment_analyzed_tweets.csv")
