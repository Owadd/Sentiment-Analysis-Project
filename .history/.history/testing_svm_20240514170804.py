...
try:
    ...
    new_df = pd.read_csv('path_to_new_dataset.csv')
    ...
    print("Error: The file path provided does not exist or the file could not be found.")
except ValueError as ve:
    print("ValueError occurred:", ve)
except Exception as e:
    print("An error occurred while loading or processing the dataset:", e)
