...
train_data_file = "sentiment_training_data.csv"
...
# KNN Imputation for handling missing values in text data
imputer = KNNImputer(n_neighbors=5)  # Adjust n_neighbors as needed
tweets_transformed = imputer.fit_transform(tweets.values.reshape(-1, 1))  # Reshape for 2D compatibility
