...
# Handle NaN values (assuming they might be present in the text data)
imputer = SimpleImputer(strategy="fill_constant", fill_value="")  # Replace with most suitable strategy
tweets = imputer.fit_transform(tweets.values.reshape(-1, 1))  # Reshape for 2D compatibility
